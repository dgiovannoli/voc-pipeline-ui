"""
Test script to process your existing CSV with timestamps
Run this to test timestamp extraction on your CSV data.
"""
...
def test_csv_with_timestamps(csv_path, client_id="test_client", max_rows=3, save_to_db=False):
    """Test timestamp extraction on your CSV file"""
    
    print("="*70)
    print("TESTING CSV WITH TIMESTAMP EXTRACTION")
    print("="*70)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python test_csv_timestamps.py <csv_file> [client_id] [max_rows] [save_to_db]")
        print("Example: python test_csv_timestamps.py my_data.csv my_client 3 true")
        sys.exit(1)
    ...
    test_csv_with_timestamps(csv_path, client_id, max_rows, save_to_db)
