...
PROMPT = (
	...
	"   - Use proper nouns present in the transcript (e.g., ShipStation API, Rocketship); avoid generic phrasing (e.g., replace ‘automation is key’ with ‘Rocketship’s multi‑piece automation reduced manual packing’).\n\n"
