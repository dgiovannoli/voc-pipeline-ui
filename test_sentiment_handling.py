#!/usr/bin/env python3
"""
Test script for improved sentiment handling in Stage 2 analyzer
"""
...
def test_sentiment_handling():
    """Test the improved sentiment handling with multiple criteria"""
    try:
